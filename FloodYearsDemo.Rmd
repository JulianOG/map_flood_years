---
title: "Demo mapping storm-tide flood years for Northern Australia"
...
Zoom in and out to focus on specific areas or one of the 20 Torres Strait islands and Yarrabah. Use the layers control to tick on/off timeframes or switch basemaps (OpenStreetMap or Satellite). The legend explains the color-coded number of flood years for the 30 year periods, ranging from frequent (light blue) to less frequent (magenta). Click on green circle markers to view detailed historic flood-year plots for each island and Yarrabah.  
